...
export const GAME_LEVELS = [
  {
    ...
    rewards: {
      rewardIds: [
        ...
        REWARDS.STARTING_HAND_REWARDS.RESOURCE_SUPPLY_EVENT_DECK_REWARD.id,
  ...
  },
  {
    ...
    rewards: {
      rewardIds: [
        ...
        REWARDS.STARTING_HAND_REWARDS.BARTER_EVENT_DECK_REWARD.id,
  ...
  },
  {
    ...
    rewards: {
      rewardIds: [
        ...
        REWARDS.STARTING_HAND_REWARDS.RAW_EXPORT_EVENT_DECK_REWARD.id,
  ...
  },
  {
    ...
    rewards: {
      rewardIds: [
        REWARDS.STARTING_HAND_REWARDS.DRONE_EVENT_DECK_REWARD.id,
      ],
      resources: {
        // Don't add any resources for this level
      }
